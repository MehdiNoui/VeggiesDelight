...
import vectorwing.farmersdelight.common.registry.ModBlocks; // For Sandy Shrub
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BELLPEPPERS_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_bellpeppers"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> BROCCOLI_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_broccoli"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> CAULIFLOWERS_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_cauliflowers"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> GARLIC_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_garlic"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> SWEET_POTATOES_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_sweet_potato"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> TURNIPS_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_turnips"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> ZUCCHINIS_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_wild_zucchinis"));
    public static final ResourceKey<ConfiguredFeature<?, ?>> MATURE_DANDELION_CONFIGURED_KEY =
            ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(VeggiesDelight.MOD_ID, "patch_mature_dandelion"));
