...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> BELLPEPPERS_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_bellpeppers"));
    public static final ResourceKey<PlacedFeature> BROCCOLI_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_broccoli"));
    public static final ResourceKey<PlacedFeature> CAULIFLOWERS_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_cauliflowers"));
    public static final ResourceKey<PlacedFeature> GARLIC_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_garlic"));
    public static final ResourceKey<PlacedFeature> SWEET_POTATOES_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_sweet_potatoes"));
    public static final ResourceKey<PlacedFeature> TURNIPS_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_turnips"));
    public static final ResourceKey<PlacedFeature> ZUCCHINIS_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_wild_zucchinis"));
    public static final ResourceKey<PlacedFeature> MATURE_DANDELION_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "patch_mature_dandelion"));
