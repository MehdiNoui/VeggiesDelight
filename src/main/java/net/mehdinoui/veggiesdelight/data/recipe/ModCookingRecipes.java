...
public class ModCookingRecipes {
    ...
    private static void cookingMeals(RecipeOutput output) {
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.BROCCOLI_SOUP.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/broccoli_soup")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.CACCIATORE.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/cacciatore")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.CAULIFLOWER_KUKU.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/cauliflower_kuku")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.CAULIFLOWER_SOUP.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .unlockedByItems("has_cauliflower", ModItems.CAULIFLOWER.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/cauliflower_soup")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.FISH_AND_CHIPS.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/fish_and_chips")));

        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.GARLIC_CHICKEN_STEW.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                .addIngredient(VDCommonTags.CROPS_GARLIC)
                .addIngredient(CommonTags.Items.FOODS_COOKED_CHICKEN)
                .addIngredient(Tags.Items.DRINKS_MILK)
                .unlockedByAnyIngredient(ModItems.GARLIC.get(),ModItems.GARLIC_CLOVE.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/garlic_chicken_stew")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.MASHED_POTATOES.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/mashed_potatoes")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.LASAGNA_PAN.get(), 1, SLOW_COOKING, LARGE_EXP, Items.BOWL)
                ...
                .addIngredient(Ingredient.fromValues(Stream.of(
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_BACON),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_BEEF),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_CHICKEN),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_MUTTON),
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/lasagna_pan")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.PASTA_WITH_BROCCOLI.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/pasta_with_broccoli")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.POTATO_NOODLES.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/potato_noodles")));
         ...
         CookingPotRecipeBuilder.cookingPotRecipe(ModItems.RICE_AND_VEGETABLES.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/rice_and_vegetables")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.ROASTED_VEGETABLES.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/roasted_veggies")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.SHAKSHOUKA.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .unlockedByItems("has_bellpepper",ModItems.BELLPEPPER.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/shakshouka")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.STUFFED_BELLPEPPERS_BLOCK.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .unlockedByItems("has_bellpepper",ModItems.BELLPEPPER.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/stuffed_bellpeppers")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.STUFFED_ZUCCHINIS.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/stuffed_zucchinis")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.TURNIP_BEEF_STEW.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/turnip_beef_stew")));

        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.TURNIP_CAKE.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                .addIngredient(VDCommonTags.CROPS_TURNIP)
                .addIngredient(CommonTags.Items.CROPS_GRAIN)
                .addIngredient(CommonTags.Items.CROPS_RICE)
                .addIngredient(Ingredient.fromValues(Stream.of(
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_BACON),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_BEEF),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_CHICKEN),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_SAFE_RAW_FISH),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_MUTTON),
                        new Ingredient.TagValue(CommonTags.Items.FOODS_RAW_PORK)
                )))
                .unlockedByItems("has_turnip",ModItems.TURNIP.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/turnip_cake")));
    ...
    private static void cookMiscellaneous(RecipeOutput output) {
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.GARLIC_STUFFED_MUSHROOMS.get(), 1, NORMAL_COOKING, MEDIUM_EXP)
                ...
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/garlic_stuffed_mushrooms")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.POTATO_NOODLE.get(), 3, FAST_COOKING, SMALL_EXP)
                ...
                .unlockedByAnyIngredient(Items.POTATO,ModItems.SWEET_POTATO.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MISC)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/potato_noodle")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.SWEET_POTATO_PANCAKES.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.BOWL)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.MISC)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/sweet_potato_pancakes")));
    }
    private static void cookDrinks(RecipeOutput output) {
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.CARROT_JUICE.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.GLASS_BOTTLE)
                ...
                .save(output, String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/carrot_juice")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.DANDELION_JUICE.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.GLASS_BOTTLE)
                ...
                .setRecipeBookTab(CookingPotRecipeBookTab.DRINKS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/dandelion_juice")));
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(ModItems.TURNIP_WATER.get(), 1, NORMAL_COOKING, MEDIUM_EXP, Items.GLASS_BOTTLE)
                ...
                .unlockedByItems("has_turnip",ModItems.TURNIP.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.DRINKS)
                .save(output,String.valueOf(ResourceLocation.fromNamespaceAndPath(VeggiesDelight.MOD_ID, "cooking/turnip_water")));
    }
}