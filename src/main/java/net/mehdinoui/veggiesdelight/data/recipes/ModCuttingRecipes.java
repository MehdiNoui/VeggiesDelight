...
public class ModCuttingRecipes {
    public static void register(Consumer<FinishedRecipe> consumer) {
        ...
        CuttingBoardRecipeBuilder.cuttingRecipe(
                        ...
                        Ingredient.of(ForgeTags.TOOLS_KNIVES), ModItems.ZUCCHINI_QUICHE_SLICE.get(),4)
                .build(consumer,new ResourceLocation(VeggiesDelight.MOD_ID, "cutting/zucchini_quiche_slice"));
